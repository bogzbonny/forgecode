...
use crate::app::{AuthService, EnvironmentInfra, HttpInfra, User, UserUsage};
use reqwest::Url;
...
impl<I: HttpInfra + EnvironmentInfra<Config = crate::config::ForgeConfig>> ForgeAuthService<I> {
...
impl<I: HttpInfra + EnvironmentInfra<Config = crate::config::ForgeConfig>> AuthService
