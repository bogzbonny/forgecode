...
use crate::domain::{FileInfo, Image};
...
impl<F: FileInfoInfra + EnvironmentInfra<Config = crate::config::ForgeConfig> + InfraFsReadService>
...
mod tests {
    ...
    use super::*;
    use crate::services::attachment::tests::MockFileService;
