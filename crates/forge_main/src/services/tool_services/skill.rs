...
use crate::app::SkillFetchService;
...
impl<R: crate::domain::SkillRepository> SkillFetchService for ForgeSkillFetch<R> {
...
impl<R: crate::domain::SkillRepository> ForgeSkillFetch<R> {
...
mod tests {
    ...
    #[async_trait::async_trait]
    impl crate::domain::SkillRepository for MockSkillRepository {
