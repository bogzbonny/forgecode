...
use anyhow::bail;
use crate::app::domain::Environment;
use crate::app::{CommandInfra, EnvironmentInfra, ShellOutput, ShellService};
...
mod tests {
    ...
    use crate::app::domain::{CommandOutput, Environment};
    use crate::app::{CommandInfra, EnvironmentInfra, ShellService};
    use crate::domain::ConfigOperation;
