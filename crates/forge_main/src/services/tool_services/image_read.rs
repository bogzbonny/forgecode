...
use anyhow::Context;
use crate::app::domain::Image;
use crate::app::{EnvironmentInfra, FileInfoInfra, ImageReadService};
...
> ImageReadService for ForgeImageRead<F>
{
    async fn read_image(&self, path: String) -> anyhow::Result<Image> {
        ...
        // limit
        crate::services::tool_services::fs_read::assert_file_size(&*self.infra, path, max_image_size_bytes)
            .await
            .with_context(
