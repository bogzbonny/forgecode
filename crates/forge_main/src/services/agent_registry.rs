...
use dashmap::DashMap;
use crate::app::domain::AgentId;
use crate::app::{AgentRepository, EnvironmentInfra};
...
impl<R: AgentRepository + EnvironmentInfra<Config = crate::config::ForgeConfig>>
...
impl<R: AgentRepository + EnvironmentInfra<Config = crate::config::ForgeConfig> + Send + Sync>
    crate::app::AgentRegistry for ForgeAgentRegistryService<R>
{
