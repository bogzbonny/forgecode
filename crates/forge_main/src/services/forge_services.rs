...
use crate::services::provider_auth::ForgeProviderAuthService;
use crate::services::agent_registry::ForgeAgentRegistryService;
use crate::services::app_config::ForgeAppConfigService;
use crate::services::attachment::ForgeChatRequest;
use crate::services::auth::ForgeAuthService;
use crate::services::command::CommandLoaderService as ForgeCommandLoaderService;
use crate::services::conversation::ForgeConversationService;
use crate::services::discovery::ForgeDiscoveryService;
use crate::services::fd::FdDefault;
use crate::services::instructions::ForgeCustomInstructionsService;
use crate::services::mcp::{ForgeMcpManager, ForgeMcpService};
use crate::services::policy::ForgePolicyService;
use crate::services::provider_service::ForgeProviderService;
use crate::services::template::ForgeTemplateService;
use crate::services::tool_services::{
...
> {
    ...
    workspace_service: Arc<crate::services::context_engine::ForgeWorkspaceService<F, FdDefault<F>>>,
...
impl<
    F: McpServerInfra
        + EnvironmentInfra<Config = crate::config::ForgeConfig>
        + FileWriterInfra
        + FileInfoInfra
        + FileReaderInfra
        + HttpInfra
...
> ForgeServices<F>
{
    pub fn new(infra: Arc<F>) -> Self {
        ...
        let workspace_service = Arc::new(crate::services::context_engine::ForgeWorkspaceService::new(
            infra.clone(),
            discovery,
        ));
...
> Services for ForgeServices<F>
{
    ...
    type WorkspaceService = crate::services::context_engine::ForgeWorkspaceService<F, FdDefault<F>>;
...
impl<
    F: EnvironmentInfra<Config = crate::config::ForgeConfig>
        ...
        + Send
        + Sync,
> crate::app::EnvironmentInfra for ForgeServices<F>
{
