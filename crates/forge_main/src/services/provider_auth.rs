...
use crate::app::{AuthStrategy, ProviderAuthService, StrategyFactory};
use crate::domain::{
    ...
    async fn init_provider_auth(
        ...
        let required_params = if matches!(auth_method, AuthMethod::ApiKey) {
            ...
            let provider = providers
                ...
                .ok_or_else(|| crate::domain::Error::provider_not_available(provider_id.clone()))?;
                        ...
                        | AuthMethod::OAuthCode(_) => {
                            ...
                            let existing_credential =
                                self.infra.get_credential(&provider.id).await?.ok_or_else(
                                    || crate::domain::Error::ProviderNotAvailable {
