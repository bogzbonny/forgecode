...
impl<F: FileReaderInfra + FileWriterInfra + FileInfoInfra + EnvironmentInfra + DirectoryReaderInfra>
    crate::app::CommandLoaderService for CommandLoaderService<F>
{
...
mod tests {
    ...
    async fn test_parse_basic_command() {
        let content = fixture!("src/services/fixtures/commands/basic.md").await;
    ...
    async fn test_parse_command_with_multiline_prompt() {
        let content = fixture!("src/services/fixtures/commands/multiline.md").await;
    ...
    async fn test_parse_invalid_frontmatter() {
        let content = fixture!("src/services/fixtures/commands/invalid.md").await;
