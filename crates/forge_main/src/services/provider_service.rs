...
impl<R> ForgeProviderService<R> {
    ...
    fn render_url_template(
        &self,
        template: &str,
        params: &HashMap<crate::domain::URLParam, crate::domain::URLParamValue>,
    ) -> Result<Url> {
        ...
        let handlebars = crate::app::TemplateEngine::handlebar_instance();
...
#[cfg(test)]
mod tests {
    use crate::app::domain::ProviderId;
    use crate::domain::{
    ...
    fn test_provider() -> Provider<Url> {
        Provider {
            ...
            response: Some(crate::app::domain::ProviderResponse::OpenAI),
            url: Url::parse("https://api.openai.com/v1/chat/completions").unwrap(),
            auth_methods: vec![AuthMethod::ApiKey],
            url_params: vec![],
            credential: Some(AuthCredential {
                id: ProviderId::OPENAI_COMPATIBLE,
                auth_details: AuthDetails::ApiKey(crate::domain::ApiKey::from(
                    "test-key".to_string(),
                )),
    ...
    fn test_template_provider() -> ProviderTemplate {
        Provider {
            ...
            provider_type: ProviderType::Llm,
            response: Some(crate::app::domain::ProviderResponse::OpenAI),
            url: Template::<crate::domain::URLParameters>::new(
            ...
            models: Some(ModelSource::Url(
                Template::<crate::domain::URLParameters>::new("https://api.openai.com/v1/models"),
            )),
            custom_headers: None,
        }
    }
