...
use anyhow::Context;
use crate::app::{EnvironmentInfra, FileReaderInfra, TemplateService};
...
impl<F: EnvironmentInfra + FileReaderInfra> ForgeTemplateService<F> {
    ...
    async fn get_hb(&self) -> &RwLock<Handlebars<'static>> {
        self.hb
            .get_or_init(|| async { RwLock::new(crate::app::TemplateEngine::handlebar_instance()) })
            .await
    }
...
mod tests {
    ...
    use super::*;
    use crate::services::attachment::tests::MockCompositeService;
