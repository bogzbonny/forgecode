...
use crate::services::range::resolve_range;
...
pub mod tests {
    ...
    use base64::Engine;
    use bytes::Bytes;
    use crate::app::domain::{AttachmentContent, Environment};
    use crate::app::utils::compute_hash;
    use crate::app::{
    ...
    use crate::domain::{ConfigOperation, FileInfo};
    use futures::stream;
    ...
    impl EnvironmentInfra for MockEnvironmentInfra {
        ...
        fn get_config(&self) -> anyhow::Result<crate::config::ForgeConfig> {
            Ok(crate::config::ForgeConfig { max_read_lines: 2000, ..Default::default() })
        }
    ...
    impl FileWriterInfra for MockFileService {
        ...
        async fn write_temp(&self, _: &str, _: &str, content: &str) -> anyhow::Result<PathBuf> {
            let temp_dir = crate::services::utils::TempDir::new().unwrap();
