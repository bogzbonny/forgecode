...
use crate::app::EnvironmentInfra;
use crate::config::{ConfigReader, ForgeConfig, ModelConfig};
use crate::domain::{ConfigOperation, Environment};
use tracing::debug;

/// Builds a [`crate::domain::Environment`] from runtime context only.
///
    ...
    match op {
        ...
        ConfigOperation::SetReasoningEffort(effort) => {
            let config_effort = match effort {
                crate::domain::Effort::None => crate::config::Effort::None,
                crate::domain::Effort::Minimal => crate::config::Effort::Minimal,
                crate::domain::Effort::Low => crate::config::Effort::Low,
                crate::domain::Effort::Medium => crate::config::Effort::Medium,
                crate::domain::Effort::High => crate::config::Effort::High,
                crate::domain::Effort::XHigh => crate::config::Effort::XHigh,
                crate::domain::Effort::Max => crate::config::Effort::Max,
            };
            let reasoning = fc
                .reasoning
                .get_or_insert_with(crate::config::ReasoningConfig::default);
...
mod tests {
    ...
    fn test_apply_config_op_set_model() {
        use crate::domain::{ModelConfig as DomainModelConfig, ModelId, ProviderId};
    ...
    fn test_apply_config_op_set_session_config_replaces_existing() {
        use crate::config::ModelConfig as ForgeCfgModelConfig;
        use crate::domain::{ModelConfig as DomainModelConfig, ModelId, ProviderId};
