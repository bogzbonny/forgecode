...
use crate::app::{AuthStrategy, OAuthHttpProvider, StrategyFactory};
use crate::domain::{
...
use crate::infra::auth::error::Error as AuthError;
use crate::infra::auth::http::{GithubHttpProvider, StandardHttpProvider};
use crate::infra::auth::util::*;
...
async fn poll_for_tokens(
    device_code: &crate::domain::DeviceCode,
    config: &OAuthConfig,
    timeout: Duration,
...
impl ForgeAuthStrategyFactory {
    pub fn new(_environment: crate::domain::Environment) -> Self {
        Self
    }
}
...
impl StrategyFactory for ForgeAuthStrategyFactory {
    ...
    fn create_auth_strategy(
        ...
        match auth_method {
            crate::domain::AuthMethod::ApiKey => Ok(AnyAuthStrategy::ApiKey(ApiKeyStrategy::new(
                provider_id,
                required_params,
            ))),
            crate::domain::AuthMethod::OAuthCode(config) => {
            ...
            crate::domain::AuthMethod::OAuthDevice(config) => {
