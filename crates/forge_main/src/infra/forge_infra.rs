...
use crate::infra::auth::{AnyAuthStrategy, ForgeAuthStrategyFactory};
use crate::infra::console::StdConsoleWriter;
use crate::infra::env::{ForgeEnvironmentInfra, to_environment};
use crate::infra::executor::ForgeCommandExecutorService;
use crate::infra::fs_create_dirs::ForgeCreateDirsService;
use crate::infra::fs_meta::ForgeFileMetaService;
use crate::infra::fs_read::ForgeFileReadService;
use crate::infra::fs_read_dir::ForgeDirectoryReaderService;
use crate::infra::fs_remove::ForgeFileRemoveService;
use crate::infra::fs_write::ForgeFileWriteService;
use crate::infra::grpc::ForgeGrpcClient;
use crate::infra::http::ForgeHttpInfra;
use crate::infra::inquire::ForgeInquire;
use crate::infra::mcp_client::ForgeMcpClient;
use crate::infra::mcp_server::ForgeMcpServer;
use crate::infra::walker::ForgeWalkerService;
...
impl ForgeInfra {
    ...
    pub fn new(cwd: PathBuf, config: crate::config::ForgeConfig) -> Self {
...
impl ForgeInfra {
    ...
    pub fn config(&self) -> anyhow::Result<crate::config::ForgeConfig> {
...
impl McpServerInfra for ForgeInfra {
    ...
    async fn connect(
        ...
        environment: &crate::domain::Environment,
...
impl WalkerInfra for ForgeInfra {
    async fn walk(&self, config: crate::app::Walker) -> anyhow::Result<Vec<crate::app::WalkedFile>> {
...
impl crate::domain::ConsoleWriter for ForgeInfra {
