...
use crate::app::domain::{Context as ChatContext, ContextMessage, MessagePhase, Role, ToolChoice};
use crate::app::utils::enforce_strict_schema;
use crate::domain::{Effort, ReasoningConfig, ReasoningFull};
...
mod tests {
    ...
    fn test_codex_request_from_context_converts_messages_tools_and_results() -> anyhow::Result<()> {
        ...
        let tool_definition =
            crate::app::domain::ToolDefinition::new("shell").description("Run a shell command");

        let tool_call = crate::app::domain::ToolCallFull::new("shell")
            .call_id(ToolCallId::new("call_1"))
            .arguments(crate::app::domain::ToolCallArguments::from_json(
                r#"{"cmd":"echo hi"}"#,
            ));

        let tool_result = crate::app::domain::ToolResult::new("shell")
    ...
    fn fixture_tool_definition(name: &str) -> crate::app::domain::ToolDefinition {
        crate::app::domain::ToolDefinition::new(name).description("Test tool")
    }

    fn fixture_tool_call(name: &str, call_id: &str, args: &str) -> crate::app::domain::ToolCallFull {
        crate::app::domain::ToolCallFull::new(name)
            .call_id(ToolCallId::new(call_id))
            .arguments(crate::app::domain::ToolCallArguments::from_json(args))
    }
    ...
    fn test_codex_request_tools_snapshot() -> anyhow::Result<()> {
        ...
        let tool = crate::app::domain::ToolDefinition::new("shell")
    ...
    fn test_codex_request_all_catalog_tools_snapshot() -> anyhow::Result<()> {
        use crate::app::domain::ToolCatalog;
    ...
    -> anyhow::Result<()> {
        use crate::domain::ReasoningFull;
    ...
    fn test_codex_request_with_temperature() -> anyhow::Result<()> {
        use crate::app::domain::Temperature;
    ...
    fn test_codex_request_with_empty_assistant_message() -> anyhow::Result<()> {
        ...
        let context = ChatContext::default()
            ...
            .add_message(ContextMessage::tool_result(
                crate::app::domain::ToolResult::new("shell")
                    .call_id(Some(ToolCallId::new("call_1")))
                    .success("output"),
            ));
    ...
    fn test_codex_request_with_tool_call_missing_call_id_returns_error() {
        let tool_call = crate::app::domain::ToolCallFull::new("shell").arguments(
            crate::app::domain::ToolCallArguments::from_json(r#"{"cmd":"ls"}"#),
        );
    ...
    fn test_codex_request_with_tool_result_missing_call_id_returns_error() {
        let context = ChatContext::default()
            .add_message(ContextMessage::user("Run command", None))
            .add_message(ContextMessage::tool_result(
                crate::app::domain::ToolResult::new("shell").success("output"),
            ));
    ...
    fn test_codex_request_preserves_phase_on_assistant_message() -> anyhow::Result<()> {
        use crate::app::domain::{MessagePhase, TextMessage};
        ...
        let context = ChatContext::default()
            .add_message(ContextMessage::user("Hello", None))
            .add_entry(crate::app::domain::MessageEntry::from(ContextMessage::Text(
                assistant_msg,
            )))
            .add_message(ContextMessage::user("Continue", None));
