            ...
            match item {
                ...
                oai::OutputItem::Reasoning(reasoning) => {
                    ...
                    if let Some(encrypted_content) = &reasoning.encrypted_content {
                        message =
                            message.add_reasoning_detail(crate::domain::Reasoning::Full(vec![
...
fn retain_encrypted_reasoning_details(
    details: Option<Vec<crate::domain::Reasoning>>,
) -> Option<Vec<crate::domain::Reasoning>> {
    let details = details?;
    let encrypted: Vec<crate::domain::Reasoning> = details
        .into_iter()
        .filter(|r| {
                        ...
                        Ok(StreamItem::Event(event)) => match *event {
                            ...
                            oai::ResponseStreamEvent::ResponseReasoningTextDelta(delta) => {
                                Some(Ok(ChatCompletionMessage::default()
                                    ...
                                    .add_reasoning_detail(crate::domain::Reasoning::Part(vec![
                                        crate::domain::ReasoningPart {
...
mod tests {
    ...
    use crate::app::domain::{Content, FinishReason, Reasoning, ReasoningFull, TokenCount, Usage};
    use crate::domain::{ChatCompletionMessage as Message, ToolCallId, ToolName};
    ...
    fn test_response_into_domain_preserves_commentary_phase() {
        ...
        assert_eq!(
            actual.phase,
            Some(crate::app::domain::MessagePhase::Commentary)
        );
    ...
    fn test_response_into_domain_preserves_final_answer_phase() {
        ...
        assert_eq!(
            actual.phase,
            Some(crate::app::domain::MessagePhase::FinalAnswer)
        );
    ...
    async fn test_stream_with_reasoning_text_delta() -> anyhow::Result<()> {
        ...
        assert_eq!(
            actual.reasoning_details,
            Some(vec![Reasoning::Part(vec![crate::domain::ReasoningPart {
