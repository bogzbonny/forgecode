...
use anyhow::anyhow;
use crate::domain::{CodebaseQueryResult, ToolCallContext, ToolCatalog, ToolOutput};

use crate::app::fmt::content::FormatContent;
use crate::app::operation::{TempContentFiles, ToolOperation};
use crate::app::services::{Services, ShellService};
use crate::app::{
        ...
        Ok(match input {
            ...
            ToolCatalog::SemSearch(input) => {
                ...
                let params: Vec<_> = input
                    ...
                    .iter()
                    .map(|search_query| {
                        crate::domain::SearchParams::new(&search_query.query, &search_query.use_case)
                            .limit(limit)
                            .top_k(top_k)
                    })
                    .collect();
                ...
                crate::app::search_dedup::deduplicate_results(&mut results);
                ...
                let output = crate::domain::CodebaseSearchResults { queries: output };
