...
use crate::domain::{ChatResponseContent, Environment, TitleFormat};

use crate::app::fmt::content::FormatContent;
use crate::app::fmt::todo_fmt::{format_todos, format_todos_diff};
use crate::app::operation::ToolOperation;
...
mod tests {
    ...
    use crate::display::DiffFormat;
    use crate::domain::{ChatResponseContent, Environment, FileInfo};
    ...
    fn test_fs_create_with_warning() {
        ...
        let fixture = ToolOperation::FsWrite {
            ...
            output: FsWriteOutput {
                ...
                before: None,
                errors: vec![crate::domain::SyntaxError {
                    line: 5,
                    column: 10,
    ...
    fn test_fs_remove() {
        let fixture = ToolOperation::FsRemove {
            input: crate::domain::FSRemove { path: "/home/user/project/file.txt".to_string() },
    ...
    fn test_fs_undo() {
        let fixture = ToolOperation::FsUndo {
            input: crate::domain::FSUndo { path: "/home/user/project/test.txt".to_string() },
            output: FsUndoOutput {
    ...
    fn test_plan_create() {
        let fixture = ToolOperation::PlanCreate {
            ...
            output: crate::app::PlanCreateOutput {
        ...
        if let Some(ChatResponseContent::ToolInput(title)) = actual {
            ...
            assert_eq!(title.category, crate::domain::Category::Debug);
