...
use crate::app::transformers::SummaryTransformer;
    ...
    fn compress_single_sequence(
        ...
        if let Some(reasoning) = reasoning_details
            && let Some(ContextMessage::Text(msg)) = context
                .messages
                .iter_mut()
                .find(|msg| msg.has_role(crate::domain::Role::Assistant))
                .map(|msg| &mut **msg)
            && msg
                .reasoning_details
                .as_ref()
...
mod tests {
    ...
    fn test_template_engine_renders_summary_frame() {
        use crate::domain::{ContextSummary, Role, SummaryBlock, SummaryMessage, SummaryToolCall};
        ...
        let messages = vec![
            ...
            SummaryBlock::new(
                Role::Assistant,
                vec![
                    SummaryToolCall::codebase_search(vec![crate::domain::SearchQuery::new(
    ...
    fn test_template_engine_renders_todo_write() {
        ...
        let messages = vec![
            ...
            SummaryBlock::new(
                ...
                vec![
                    SummaryToolCall {
                        id: Some(crate::domain::ToolCallId::new("call_1")),
    ...
    async fn test_render_summary_frame_snapshot() {
        ...
        let fixture_json = fixture!("/src/app/fixtures/conversation.json").await;
    ...
    fn test_compaction_removes_droppable_messages() {
        use crate::domain::{ContextMessage, Role, TextMessage};
    ...
    fn test_compaction_preserves_usage_information() {
        use crate::domain::{TokenCount, Usage};
    ...
    fn ctx(pattern: &str) -> Context {
        crate::domain::MessagePattern::new(pattern).build()
    }
    ...
    fn test_safe_threshold_triggers_earlier_than_unsafe_threshold() {
        use crate::domain::{ContextMessage, ToolCallId, ToolName, ToolResult};
    ...
    fn create_large_context(token_count: usize) -> Context {
        use crate::domain::ContextMessage;
