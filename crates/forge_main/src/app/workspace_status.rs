...
use crate::domain::{FileHash, FileStatus, SyncProgress, SyncStatus};
    ...
    fn test_file_statuses() {
        ...
        let expected = vec![
            ...
            crate::domain::FileStatus::new(
                ...
                crate::domain::SyncStatus::Modified,
            ),
            crate::domain::FileStatus::new(
                "/workspace/c.rs".to_string(),
                crate::domain::SyncStatus::Deleted,
            ),
            crate::domain::FileStatus::new(
                "/workspace/d.rs".to_string(),
                crate::domain::SyncStatus::New,
            ),
        ];
