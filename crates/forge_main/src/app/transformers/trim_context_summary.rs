use crate::domain::{ContextSummary, Role, SummaryMessage, SummaryTool, Transformer};
...
enum Operation<'a> {
    ...
    CodebaseSearch {
        queries: &'a [crate::domain::SearchQuery],
    },
...
#[cfg(test)]
mod tests {
    use crate::domain::{Role, SummaryBlock, SummaryToolCall, ToolCallId};
