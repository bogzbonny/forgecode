...
use crate::app::{WalkedFile, Walker};
...
pub trait AuthStrategy: Send + Sync {
    ...
    async fn init(&self) -> anyhow::Result<crate::domain::AuthContextRequest>;

    /// Complete authentication flow
    async fn complete(
        &self,
        context_response: crate::domain::AuthContextResponse,
    ) -> anyhow::Result<crate::domain::AuthCredential>;
...
///
/// This trait provides access to fully-resolved domain [`crate::domain::Agent`]
/// values from:
