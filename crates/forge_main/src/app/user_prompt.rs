...
use crate::app::{AttachmentService, EnvironmentInfra, TemplateEngine};
...
impl<S: AttachmentService + EnvironmentInfra<Config = crate::config::ForgeConfig>>
...
mod tests {
    ...
    impl crate::app::EnvironmentInfra for MockService {
    ...
    async fn test_attachments_tracked_as_read_operations() {
        ...
        impl crate::app::EnvironmentInfra for MockServiceWithFiles {
            type Config = crate::config::ForgeConfig;
            fn get_environment(&self) -> crate::domain::Environment {
                use fake::{Fake, Faker};
                Faker.fake()
    ...
    async fn test_todos_injected_on_resume() {
        ...
        impl crate::app::EnvironmentInfra for MockServiceWithTodos {
            type Config = crate::config::ForgeConfig;
            fn get_environment(&self) -> crate::domain::Environment {
                use fake::{Fake, Faker};
                Faker.fake()
    ...
    async fn test_todos_not_injected_on_new_conversation() {
        ...
        impl crate::app::EnvironmentInfra for MockServiceNoTodos {
            type Config = crate::config::ForgeConfig;
            fn get_environment(&self) -> crate::domain::Environment {
                use fake::{Fake, Faker};
                Faker.fake()
