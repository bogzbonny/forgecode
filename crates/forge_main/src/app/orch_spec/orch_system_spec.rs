use crate::domain::{ChatCompletionMessage, CommandOutput, Content, FinishReason};
use insta::assert_snapshot;

use crate::app::ShellOutput;
...
async fn test_system_prompt_tool_supported() {
    let mut ctx = TestContext::default()
        .files(vec![
            crate::domain::File { path: "/users/john/foo.txt".to_string(), is_dir: false },
            crate::domain::File { path: "/users/jason/bar.txt".to_string(), is_dir: false },
        ])
