...
use crate::app::hooks::{DoomLoopDetector, PendingTodosHandler};
use crate::app::init_conversation_metrics::InitConversationMetrics;
use crate::app::orch::Orchestrator;
use crate::app::set_conversation_id::SetConversationId;
use crate::app::system_prompt::SystemPrompt;
use crate::app::user_prompt::UserPromptGenerator;
use crate::app::{
...
impl Runner {
    fn new(setup: &TestContext) -> Self {
        ...
        crate::embed::register_templates(&mut hb, &TEMPLATE_DIR);
...
impl AgentService for Runner {
    async fn chat_agent(
        &self,
        _id: &crate::domain::ModelId,
        context: crate::domain::Context,
        _provider_id: Option<ProviderId>,
    ) -> crate::domain::ResultStream<ChatCompletionMessage, anyhow::Error> {
    ...
    async fn call(
        &self,
        _: &crate::domain::Agent,
        _: &crate::domain::ToolCallContext,
        test_call: crate::domain::ToolCallFull,
...
impl TemplateService for Runner {
    ...
    async fn render_template<V: serde::Serialize + Send + Sync>(
        &self,
        template: crate::domain::Template<V>,
        object: &V,
...
impl AttachmentService for Runner {
    async fn attachments(&self, _url: &str) -> anyhow::Result<Vec<crate::domain::Attachment>> {
...
impl SkillFetchService for Runner {
    async fn fetch_skill(&self, _skill_name: String) -> anyhow::Result<crate::domain::Skill> {
