...
use crate::app::{AgentProviderResolver, EnvironmentInfra, Services};
...
impl<S: Services + EnvironmentInfra<Config = crate::config::ForgeConfig>> GitApp<S> {
    ...
    async fn generate_commit_message(
        ...
        crate::app::retry::retry_with_config(
            &retry_config,
    ...
    async fn generate_message_from_diff(&self, ctx: DiffContext) -> Result<CommitMessageDetails> {
        ...
        let context = crate::domain::Context::default()
