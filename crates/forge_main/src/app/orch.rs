...
use crate::app::agent::AgentService;
use crate::app::{EnvironmentInfra, TemplateEngine};
...
impl<S: AgentService + EnvironmentInfra<Config = crate::config::ForgeConfig>> Orchestrator<S> {
    pub fn new(
        services: Arc<S>,
        conversation: Conversation,
        agent: Agent,
    ...
    pub async fn run(&mut self) -> anyhow::Result<()> {
        ...
        while !should_yield {
            ...
            let message = crate::app::retry::retry_with_config(
