...
impl From<crate::domain::ToolChoice> for ToolChoice {
    fn from(value: crate::domain::ToolChoice) -> Self {
        match value {
            crate::domain::ToolChoice::None => ToolChoice::None,
            crate::domain::ToolChoice::Auto => ToolChoice::Auto,
            crate::domain::ToolChoice::Required => ToolChoice::Required,
            crate::domain::ToolChoice::Call(tool_name) => ToolChoice::Function {
