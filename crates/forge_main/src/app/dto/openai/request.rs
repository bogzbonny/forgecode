    ...
    fn from(context: Context) -> Self {
        Request {
            ...
            response_format: context.response_format.map(|rf| match rf {
                crate::domain::ResponseFormat::Text => ResponseFormat::Text,
                crate::domain::ResponseFormat::JsonSchema(schema) => {
...
impl From<crate::domain::Role> for Role {
    fn from(role: crate::domain::Role) -> Self {
        match role {
            crate::domain::Role::System => Role::System,
            crate::domain::Role::User => Role::User,
            crate::domain::Role::Assistant => Role::Assistant,
        }
    }
}
...
<task>
    ...
    fn test_assistant_message_with_dump_style_tool_call_arguments_conversion() {
        ...
        .arguments(
            serde_json::from_str::<crate::domain::ToolCallArguments>(
    ...
    fn test_context_conversion_stream_defaults_to_true() {
        let fixture = crate::domain::Context::default();
    ...
    fn test_context_conversion_stream_explicit_true() {
        let fixture = crate::domain::Context::default().stream(true);
        let actual = Request::from(fixture);
    ...
    fn test_context_conversion_stream_explicit_false() {
        let fixture = crate::domain::Context::default().stream(false);
        let actual = Request::from(fixture);
    ...
    fn test_response_format_json_schema_serialization() {
        ...
        let fixture = crate::domain::Context::default()
            .response_format(crate::domain::ResponseFormat::JsonSchema(Box::new(schema)));
