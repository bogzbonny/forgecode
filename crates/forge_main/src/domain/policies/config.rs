...
mod tests {
    ...
    use super::*;
    use crate::domain::{Permission, PermissionOperation, Policy, Rule, WriteRule};
    ...
    mod yaml_policies_tests {
        use crate::domain::policies::{Permission, Policy, PolicyConfig, Rule};
        use crate::fixture;

        #[tokio::test]
        async fn test_yaml_policies_roundtrip() {
            let yaml_content = fixture!("/src/domain/fixtures/policies_test.yml").await;
