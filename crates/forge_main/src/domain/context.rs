...
use crate::domain::temperature::Temperature;
use crate::domain::top_k::TopK;
use crate::domain::top_p::TopP;
use crate::domain::{
...
pub struct Context {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reasoning: Option<crate::domain::ReasoningConfig>,
...
impl Context {
    ...
    pub fn is_reasoning_supported(&self) -> bool {
        self.reasoning.as_ref().is_some_and(|reasoning| {
            ...
            // `max_tokens`.
            if matches!(reasoning.effort, Some(crate::domain::Effort::None)) {
                return false;
            }
...
mod tests {
    ...
    use crate::domain::{DirectoryEntry, FileInfo, estimate_token_count};
    ...
    fn test_update_image_tool_calls_empty_context() {
        ...
        let mut transformer = crate::domain::transformer::ImageHandling::new();
    ...
    fn test_update_image_tool_calls_tool_results_no_images() {
        let fixture = Context::default()
            ...
            .add_tool_results(vec![
                ToolResult {
                    name: crate::domain::ToolName::new("text_tool"),
                    call_id: Some(crate::domain::ToolCallId::new("call1")),
                    output: crate::domain::ToolOutput::text("Text output".to_string()),
                },
                ToolResult {
                    name: crate::domain::ToolName::new("empty_tool"),
                    call_id: Some(crate::domain::ToolCallId::new("call2")),
                    output: crate::domain::ToolOutput {
                        values: vec![crate::domain::ToolValue::Empty],
                        is_error: false,
                    },
                },
            ]);
    ...
    fn test_update_image_tool_calls_single_image() {
        ...
        let fixture = Context::default()
            ...
            .add_tool_results(vec![ToolResult {
                name: crate::domain::ToolName::new("image_tool"),
                call_id: Some(crate::domain::ToolCallId::new("call1")),
                output: crate::domain::ToolOutput::image(image),
            }]);
    ...
    fn test_update_image_tool_calls_multiple_images_single_tool_result() {
        ...
        let fixture = Context::default().add_tool_results(vec![ToolResult {
            name: crate::domain::ToolName::new("multi_image_tool"),
            call_id: Some(crate::domain::ToolCallId::new("call1")),
            output: crate::domain::ToolOutput {
                values: vec![
                    crate::domain::ToolValue::Text("First text".to_string()),
                    crate::domain::ToolValue::Image(image1),
                    crate::domain::ToolValue::Text("Second text".to_string()),
                    crate::domain::ToolValue::Image(image2),
                ],
                is_error: false,
            },
        }]);
    ...
    fn test_update_image_tool_calls_multiple_tool_results_with_images() {
        ...
        let fixture = Context::default()
            ...
            .add_tool_results(vec![
                ...
                ToolResult {
                    name: crate::domain::ToolName::new("image_tool1"),
                    call_id: Some(crate::domain::ToolCallId::new("call2")),
                    output: crate::domain::ToolOutput::image(image1),
                },
                ToolResult {
                    name: crate::domain::ToolName::new("image_tool2"),
                    call_id: Some(crate::domain::ToolCallId::new("call3")),
                    output: crate::domain::ToolOutput::image(image2),
                },
            ]);
    ...
    fn test_update_image_tool_calls_mixed_content_with_images() {
        ...
        let fixture = Context::default()
            ...
            .add_tool_results(vec![ToolResult {
                name: crate::domain::ToolName::new("mixed_tool"),
                call_id: Some(crate::domain::ToolCallId::new("call1")),
                output: crate::domain::ToolOutput {
                    values: vec![
                        crate::domain::ToolValue::Text("Before image".to_string()),
                        crate::domain::ToolValue::Image(image),
                        crate::domain::ToolValue::Text("After image".to_string()),
                        crate::domain::ToolValue::Empty,
                    ],
                    is_error: false,
                },
            }]);
    ...
    fn test_update_image_tool_calls_preserves_error_flag() {
        let image = Image::new_base64("test123".to_string(), "image/png");
        let fixture = Context::default().add_tool_results(vec![ToolResult {
            name: crate::domain::ToolName::new("error_tool"),
            call_id: Some(crate::domain::ToolCallId::new("call1")),
            output: crate::domain::ToolOutput {
                values: vec![crate::domain::ToolValue::Image(image)],
                is_error: true,
            },
        }]);
    ...
    fn test_context_is_reasoning_supported_when_enabled() {
        let fixture = Context::default()
            .reasoning(crate::domain::ReasoningConfig { enabled: Some(true), ..Default::default() });
    ...
    fn test_context_is_reasoning_supported_when_effort_set() {
        let fixture = Context::default().reasoning(crate::domain::ReasoningConfig {
            effort: Some(crate::domain::Effort::High),
            ..Default::default()
        });
    ...
    fn test_context_is_reasoning_supported_when_max_tokens_positive() {
        let fixture = Context::default()
            .reasoning(crate::domain::ReasoningConfig { max_tokens: Some(1024), ..Default::default() });
    ...
    fn test_context_is_reasoning_not_supported_when_max_tokens_zero() {
        let fixture = Context::default()
            .reasoning(crate::domain::ReasoningConfig { max_tokens: Some(0), ..Default::default() });
    ...
    fn test_context_is_reasoning_not_supported_when_disabled() {
        let fixture = Context::default()
            .reasoning(crate::domain::ReasoningConfig { enabled: Some(false), ..Default::default() });
    ...
    fn test_context_is_reasoning_not_supported_when_explicitly_disabled() {
        let fixture = Context::default().reasoning(crate::domain::ReasoningConfig {
            enabled: Some(false),
            effort: Some(crate::domain::Effort::High), /* Should be ignored when
                                                * explicitly disabled */
            ..Default::default()
        });
    ...
    fn test_context_is_reasoning_not_supported_when_effort_is_none() {
        ...
        let fixture = Context::default().reasoning(crate::domain::ReasoningConfig {
            effort: Some(crate::domain::Effort::None),
            ..Default::default()
        });
        ...
        let fixture = Context::default()
            ...
            .add_message(ContextMessage::assistant(
                ...
                Some(vec![
                    ToolCallFull {
                        call_id: Some(crate::domain::ToolCallId::new("call1")),
                        name: crate::domain::ToolName::new("tool1"),
                        arguments: serde_json::json!({"arg": "value"}).into(),
                        thought_signature: None,
                    },
                    ToolCallFull {
                        call_id: Some(crate::domain::ToolCallId::new("call2")),
                        name: crate::domain::ToolName::new("tool2"),
                        arguments: serde_json::json!({"arg": "value"}).into(),
                        thought_signature: None,
                    },
                ]),
            ...
            .add_tool_results(vec![
                ToolResult {
                    name: crate::domain::ToolName::new("tool1"),
                    call_id: Some(crate::domain::ToolCallId::new("call1")),
                    output: crate::domain::ToolOutput::text("Result 1".to_string()),
                },
                ToolResult {
                    name: crate::domain::ToolName::new("tool2"),
                    call_id: Some(crate::domain::ToolCallId::new("call2")),
                    output: crate::domain::ToolOutput::text("Result 2".to_string()),
                },
            ]);
    ...
    fn test_context_message_token_count_approx_with_tool_calls() {
        ...
        let fixture_tool_calls = vec![
            ToolCallFull {
                call_id: Some(crate::domain::ToolCallId::new("call1")),
                name: crate::domain::ToolName::new("fs_search"),
                arguments: serde_json::json!({"query": "test"}).into(),
                thought_signature: None,
            },
            ToolCallFull {
                call_id: Some(crate::domain::ToolCallId::new("call2")),
                name: crate::domain::ToolName::new("calculate"),
    ...
    fn test_context_message_token_count_approx_tool_result_text() {
        ...
        let fixture = ContextMessage::tool_result(ToolResult {
            name: crate::domain::ToolName::new("fs_search"),
            call_id: Some(crate::domain::ToolCallId::new("call1")),
            output: crate::domain::ToolOutput::text("Search results: Found 3 items".to_string()),
        });
        let actual = fixture.token_count_approx();
    ...
    fn test_context_message_token_count_approx_tool_result_image() {
        ...
        let fixture_image = Image::new_base64("base64data".to_string(), "image/png");
        let fixture = ContextMessage::tool_result(ToolResult {
            name: crate::domain::ToolName::new("screenshot"),
            call_id: Some(crate::domain::ToolCallId::new("call1")),
            output: crate::domain::ToolOutput::image(fixture_image),
        });
        let actual = fixture.token_count_approx();
