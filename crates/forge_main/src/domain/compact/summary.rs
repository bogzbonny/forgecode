                        ...
                        for call in calls {
                                ...
                                ToolCatalog::try_from(call.clone())
                            {
                                for item in &input.todos {
                                    if item.status == crate::domain::TodoStatus::Cancelled {
...
mod tests {
    ...
    use super::*;
    use crate::domain::{ContextMessage, TextMessage, ToolCallArguments, ToolCallId, ToolName, ToolOutput};
    ...
    fn test_context_summary_ignores_image_messages() {
        let fixture = context(vec![
            user("User message"),
            ContextMessage::Image(crate::domain::Image::new_base64(
