...
use crate::domain::{Context, ModelId, Role};
...
pub struct Compact {
    ...
    #[merge(strategy = crate::domain::merge::std::overwrite)]
    #[serde(default)]
    ...
    #[merge(strategy = crate::domain::merge::option)]
...
mod tests {
    ...
    use super::*;
    use crate::domain::MessagePattern;
