...
use crate::domain::{Agent, ChatCompletionMessageFull, Conversation, ModelId, ToolCallFull, ToolResult};
...
mod tests {
    ...
    use super::*;
    use crate::domain::{Agent, AgentId, Conversation, ModelId, ProviderId};
