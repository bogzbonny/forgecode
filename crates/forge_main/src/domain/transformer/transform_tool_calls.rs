...
use crate::domain::{Context, ContextMessage, ModelId, Role, TextMessage};
            ...
            match &*message {
                ...
                ContextMessage::Tool(tool_result) => {
                    ...
                    for output_value in tool_result.output.values.clone() {
                        match output_value {
                            crate::domain::ToolValue::Text(text) => {
                                new_messages
                            ...
                            crate::domain::ToolValue::AI { value, .. } => new_messages
...
mod tests {
    ...
    use super::*;
    use crate::domain::{Image, ToolCallFull, ToolCallId, ToolName, ToolOutput, ToolResult, ToolValue};
    ...
    fn test_transform_tool_calls_clears_tools_field() {
        let fixture = Context::default()
            .add_tool(crate::domain::ToolDefinition {
                name: crate::domain::ToolName::new("test_tool"),
