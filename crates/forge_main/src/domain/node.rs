...
pub struct WorkspaceAuth {
    ...
    pub token: crate::domain::ApiKey,
    /// When this token was stored locally
    pub created_at: chrono::DateTime<chrono::Utc>,
}

impl From<WorkspaceAuth> for crate::domain::AuthDetails {
    fn from(auth: WorkspaceAuth) -> Self {
        crate::domain::AuthDetails::ApiKey(auth.token)
    }
}

impl WorkspaceAuth {
    /// Create a new indexing auth record
    pub fn new(user_id: UserId, token: crate::domain::ApiKey) -> Self {
