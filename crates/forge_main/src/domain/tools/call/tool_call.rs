...
use crate::domain::xml::extract_tag_content;
use crate::domain::{Error, Result, ToolCallArguments, ToolName, ToolResult};
...
impl ToolCallFull {
    ...
    pub fn requires_stdout(&self) -> bool {
        crate::domain::ToolCatalog::requires_stdout(&self.name)
    }
...
mod tests {
    ...
    async fn test_real_example() {
        let message = fixture!("/src/domain/fixtures/tool_call_01.md").await;
