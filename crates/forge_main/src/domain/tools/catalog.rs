...
use crate::domain::{ToolCallArguments, ToolCallFull, ToolDefinition, ToolDescription, ToolName};
...
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/task.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/fs_read.md"]
pub struct FSRead {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/fs_write.md"]
pub struct FSWrite {
...
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/fs_search.md"]
#[derive(Default)]
pub struct FSSearch {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/semantic_search.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/fs_remove.md"]
pub struct FSRemove {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/fs_patch.md"]
pub struct FSPatch {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/fs_multi_patch.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/fs_undo.md"]
pub struct FSUndo {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/shell.md"]
pub struct Shell {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/net_fetch.md"]
pub struct NetFetch {
    /// URL to fetch
    pub url: String,
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/followup.md"]
pub struct Followup {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/plan_create.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/skill_fetch.md"]
...
pub struct TodoItem {
    ...
    pub status: crate::domain::TodoStatus,
}

#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/todo_write.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/forge_main/src/domain/tools/descriptions/todo_read.md"]
pub struct TodoRead {}
...
impl ToolCatalog {
    ...
    pub fn to_policy_operation(
        &self,
        cwd: PathBuf,
    ) -> Option<crate::domain::policies::PermissionOperation> {
        ...
        match self {
            ToolCatalog::Read(input) => Some(crate::domain::policies::PermissionOperation::Read {
                path: std::path::PathBuf::from(&input.file_path),
                cwd,
                message: format!("Read file: {}", display_path_for(&input.file_path)),
            }),
            ToolCatalog::Write(input) => Some(crate::domain::policies::PermissionOperation::Write {
                path: std::path::PathBuf::from(&input.file_path),
                cwd,
                message: format!(
            ...
            ToolCatalog::FsSearch(input) => {
                ...
                Some(crate::domain::policies::PermissionOperation::Read {
                    path: std::path::PathBuf::from(path_str),
                    cwd,
                    message,
                })
            }
            ToolCatalog::Remove(input) => Some(crate::domain::policies::PermissionOperation::Write {
                path: std::path::PathBuf::from(&input.path),
                cwd,
                message: format!("Remove file: {}", display_path_for(&input.path)),
            }),
            ToolCatalog::Patch(input) => Some(crate::domain::policies::PermissionOperation::Write {
                path: std::path::PathBuf::from(&input.file_path),
                cwd,
                message: format!("Modify file: {}", display_path_for(&input.file_path)),
            }),
            ToolCatalog::MultiPatch(input) => Some(crate::domain::policies::PermissionOperation::Write {
                path: std::path::PathBuf::from(&input.file_path),
                cwd,
                message: format!(
            ...
            ToolCatalog::Shell(input) => Some(crate::domain::policies::PermissionOperation::Execute {
                command: input.command.clone(),
                cwd,
            }),
            ToolCatalog::Fetch(input) => Some(crate::domain::policies::PermissionOperation::Fetch {
                url: input.url.clone(),
                cwd,
    ...
    pub fn tool_call_todo_write(todos: Vec<crate::domain::TodoItem>) -> ToolCallFull {
...
impl TryFrom<ToolCallFull> for ToolCatalog {
    ...
    fn try_from(value: ToolCallFull) -> Result<Self, Self::Error> {
        ...
        serde_json::from_value(serde_json::Value::Object(map))
            .map_err(|error| crate::domain::Error::AgentCallArgument { error })
    }
}
...
impl TryFrom<&ToolCallFull> for AgentInput {
    ...
    fn try_from(value: &ToolCallFull) -> Result<Self, Self::Error> {
        ...
        serde_json::from_value(value).map_err(|error| crate::domain::Error::AgentCallArgument { error })
    }
}
...
mod tests {
    ...
    use super::Shell;
    use crate::domain::{ToolCatalog, ToolKind, ToolName};
    ...
    fn test_coerce_string_integers_to_i32() {
        use crate::domain::{ToolCallArguments, ToolCallFull};
    ...
    fn test_fs_search_message_with_regex() {
        ...
        use crate::domain::FSSearch;
        use crate::domain::policies::PermissionOperation;
    ...
    fn test_unit_enum_schema_generation() {
        ...
        use crate::domain::{OutputMode, PatchOperation};
